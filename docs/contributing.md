...
Contributions are welcome. `go-ruby-syslog/syslog` is built to a small set of
...
The library is in [`github.com/go-ruby-syslog/syslog`](https://github.com/go-ruby-syslog/syslog).
This documentation site is in [`github.com/go-ruby-syslog/docs`](https://github.com/go-ruby-syslog/docs).
