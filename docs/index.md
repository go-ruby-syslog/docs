# go-ruby-syslog documentation

**Pure-Go, MRI-4.0.5-faithful Ruby syslog (no cgo)**

`go-ruby-syslog/syslog` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `syslog`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `syslog`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`syslog`](https://github.com/go-ruby-syslog/syslog) | the library — Ruby's `syslog` in pure Go |
| [`docs`](https://github.com/go-ruby-syslog/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-syslog.github.io`](https://github.com/go-ruby-syslog/go-ruby-syslog.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-syslog/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-syslog/syslog](https://github.com/go-ruby-syslog/syslog).
