...
The public API lives at the module root (`github.com/go-ruby-syslog/syslog`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `syslog`, while the surface follows
...
```go
import "github.com/go-ruby-syslog/syslog"
```
...
- **[pkg.go.dev/github.com/go-ruby-syslog/syslog](https://pkg.go.dev/github.com/go-ruby-syslog/syslog)**

The module's [README](https://github.com/go-ruby-syslog/syslog#readme) carries worked
